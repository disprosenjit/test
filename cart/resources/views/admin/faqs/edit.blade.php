...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-1">
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-6 space-y-4">
            <div>
                <p class="text-xs text-gray-600 uppercase font-semibold">Total Views</p>
                <p class="text-2xl font-bold text-gray-900">{{ $faq->view_count }}</p>
            </div>
            <div>
                <p class="text-xs text-gray-600 uppercase font-semibold">Created</p>
                <p class="text-sm text-gray-700">{{ $faq->created_at->format('M d, Y') }}</p>
            </div>
            <div>
                <p class="text-xs text-gray-600 uppercase font-semibold">Last Updated</p>
                <p class="text-sm text-gray-700">{{ $faq->updated_at->format('M d, Y H:i') }}</p>
            </div>
        </div>
    </div>
</div>
