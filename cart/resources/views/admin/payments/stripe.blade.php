...
<div class="mb-6 flex justify-between items-center">
    <div>
        <h1 class="text-2xl font-bold">Stripe Payments</h1>
        <p class="text-gray-600 mt-1">Gateway-specific monitoring for Stripe transactions</p>
    </div>
...
<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
    <div class="bg-blue-50 p-4 rounded-lg shadow text-center">
        <p class="text-2xl font-bold text-blue-700">₹{{ number_format($stats['total'], 0) }}</p>
        <p class="text-sm text-gray-600">Stripe Volume</p>
    </div>
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <table class="w-full">
        ...
        <tbody class="divide-y">
            ...
            @empty
                <tr>
                    <td colspan="7" class="px-6 py-3 text-center text-gray-600">No Stripe payments found</td>
                </tr>
            @endforelse
        </tbody>
    </table>
