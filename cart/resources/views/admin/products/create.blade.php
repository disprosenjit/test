    ...
    <form method="POST" action="/admin/products" enctype="multipart/form-data">
        ...
        <div class="space-y-4 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="name" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('name') border-red-500 @enderror" value="{{ old('name') }}">
                    @error('name') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label class="block text-sm font-semibold mb-2">SKU *</label>
                    <input type="text" name="sku" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('sku') border-red-500 @enderror" value="{{ old('sku') }}">
                ...
                <div>
                    ...
                    <select name="vessel_type_id" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        @foreach($vesselTypes as $vesselType)
                            <option value="{{ $vesselType->id }}" {{ old('vessel_type_id') == $vesselType->id ? 'selected' : '' }}>{{ $vesselType->name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="space-y-4 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="price" step="0.01" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('price') border-red-500 @enderror" value="{{ old('price') }}">
                    @error('price') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label class="block text-sm font-semibold mb-2">Cost (₹) *</label>
                    <input type="number" name="cost" step="0.01" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('cost') border-red-500 @enderror" value="{{ old('cost') }}">
        ...
        <div class="space-y-4 mb-8">
            ...
            <div>
                ...
                <textarea name="description" required rows="4" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('description') border-red-500 @enderror">{{ old('description') }}</textarea>
        ...
        <div class="space-y-4 mb-8">
            ...
            <input type="hidden" name="specifications" id="specificationsInput" value="{{ old('specifications', '{}') }}">
        ...
        <div class="space-y-4 mb-8">
            ...
            <div>
                ...
                <textarea name="images" rows="4" placeholder="https://example.com/image1.jpg&#10;https://example.com/image2.jpg" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-sm">{{ old('images') }}</textarea>
                <p class="text-gray-500 text-xs mt-1">Enter image URLs (one URL per line). Leave empty for no images.</p>
            </div>
        </div>
        ...
        <div class="space-y-4 mb-8">
            ...
            <label class="flex items-center">
                <input type="checkbox" name="is_active" value="1" {{ old('is_active', 1) ? 'checked' : '' }} class="w-4 h-4 rounded">
        ...
        <div class="space-y-4 mb-8">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="meta_title" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('meta_title') border-red-500 @enderror" value="{{ old('meta_title') }}" placeholder="If empty, defaults to product name">
                ...
                <div>
                    ...
                    <textarea name="meta_description" rows="3" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('meta_description') border-red-500 @enderror" placeholder="If empty, defaults to product description">{{ old('meta_description') }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="meta_keywords" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('meta_keywords') border-red-500 @enderror" value="{{ old('meta_keywords') }}" placeholder="Comma-separated keywords, e.g., ship, parts, engine">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (specInput.value && specInput.value !== '{}') {
        try {
