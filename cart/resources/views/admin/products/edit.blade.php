        ...
        <div class="space-y-4 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="product-classification-field">
                    ...
                    <input type="text" name="part_number" data-physical-required="true" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('part_number') border-red-500 @enderror" value="{{ old('part_number', $product->part_number) }}">
                ...
                <div>
                    ...
                    <select name="product_type" id="productType" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('product_type') border-red-500 @enderror">
                        ...
                        <option value="downloadable" {{ old('product_type', $product->product_type) === 'downloadable' ? 'selected' : '' }}>Downloadable Product</option>
                    </select>
        ...
        <div class="space-y-4 mb-8" id="downloadFileSection">
            ...
            @if($product->hasDownloadFile())
                <div class="rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-900">
                    Current file: {{ $product->getDownloadName() }}
                </div>
            @endif
            <div>
                <label class="block text-sm font-semibold mb-2">Upload Replacement File</label>
                ...
                <p class="text-gray-500 text-xs mt-1">Upload a new file to replace the current downloadable asset.</p>
